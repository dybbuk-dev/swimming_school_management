...
import selectors from 'src/modules/user/teacherList/teacherListSelectors';
import Errors from 'src/modules/shared/error/errors';
import Message from 'src/view/shared/message';
import { i18n } from 'src/i18n';
import exporterFields from 'src/modules/user/teacherList/teacherListExporterFields';
...
const teacherListActions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      new Exporter(
        exporterFields,
        i18n('user.teacher.exporterFileName'),
  ...
  doDestroy: (id) => async (dispatch, getState) => {
    try {
      ...
      Message.success(
        i18n('user.teacher.doDestroySuccess'),
      );
  ...
  doDestroyAllSelected:
    () => async (dispatch, getState) => {
      try {
        ...
        Message.success(
          i18n('user.teacher.doDestroyAllSelectedSuccess'),
        );
