...
import selectors from 'src/modules/user/adminList/adminListSelectors';
import Errors from 'src/modules/shared/error/errors';
import Message from 'src/view/shared/message';
import { i18n } from 'src/i18n';
import exporterFields from 'src/modules/user/adminList/adminListExporterFields';
...
const adminListActions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      new Exporter(
        exporterFields,
        i18n('user.admin.exporterFileName'),
  ...
  doDestroy: (id) => async (dispatch, getState) => {
    try {
      ...
      Message.success(i18n('user.admin.doDestroySuccess'));
  ...
  doDestroyAllSelected:
    () => async (dispatch, getState) => {
      try {
        ...
        Message.success(
          i18n('user.admin.doDestroyAllSelectedSuccess'),
        );
