...
import exporterFields from 'src/modules/student/list/studentListExporterFields';
...
const studentListActions = {
  ...
  doDestroy: (id) => async (dispatch, getState) => {
    try {
      ...
      Message.success(i18n('student.doDestroySuccess'));
  ...
  doDestroyAllSelected:
    () => async (dispatch, getState) => {
      try {
        ...
        Message.success(
          i18n('student.doDestroyAllSelectedSuccess'),
        );
