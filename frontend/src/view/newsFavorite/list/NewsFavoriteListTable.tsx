...
import NewsArticleListItem from 'src/view/newsArticle/list/NewsArticleListItem';

function NewsFavoriteListTable(props) {
...
export default NewsFavoriteListTable;
