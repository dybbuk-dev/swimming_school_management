...
function ClassCategoryViewItem(props) {
  ...
  const displayableRecord = (record, lastItem = false) => {
    return (
      ...
      >
        ...
        >
          <Icon fontSize="inherit">classCategory</Icon>
        </MDBox>
...
ClassCategoryViewItem.defaultProps = {
  hiddenLabel: false,
};

ClassCategoryViewItem.propTypes = {
  label: PropTypes.string,
  value: PropTypes.any,
  hiddenLabel: PropTypes.bool,
};

export default ClassCategoryViewItem;
