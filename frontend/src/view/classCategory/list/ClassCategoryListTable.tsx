...
function ClassCategoryListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    classCategorySelectors.selectPermissionToEdit,
  );
  const hasPermissionToDestroy = useSelector(
    classCategorySelectors.selectPermissionToDestroy,
  );
  const hasPermissionToRead = useSelector(
    classCategorySelectors.selectPermissionToRead,
  );
        ...
        <Table>
          <MDBox component="thead">
            <TableRow>
              ...
              >
                {i18n('classCategory.fields.name')}
              </DataTableHeadCell>
              <DataTableHeadCell sorted={false}>
                {i18n('classCategory.fields.comment')}
              </DataTableHeadCell>
            </TableRow>
          </MDBox>
          <TableBody>
...
export default ClassCategoryListTable;
