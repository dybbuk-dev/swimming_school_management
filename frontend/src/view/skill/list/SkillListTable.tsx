...
import actions from 'src/modules/skill/list/skillListActions';
...
import GradeListItem from 'src/view/grade/list/GradeListItem';
import ImagesListView from 'src/view/shared/table/ImagesListView';

function SkillListTable(props) {
  ...
  const hasPermissionToEdit = useSelector(
    skillSelectors.selectPermissionToEdit,
  );
  const hasPermissionToDestroy = useSelector(
    skillSelectors.selectPermissionToDestroy,
  );
  const hasPermissionToRead = useSelector(
    skillSelectors.selectPermissionToRead,
  );
        ...
        <Table>
          <MDBox component="thead">
            <TableRow>
              ...
              >
                {i18n('skill.fields.name')}
              </DataTableHeadCell>
              <DataTableHeadCell
                onClick={() => doChangeSort('grade')}
                sorted={
                  sorter.field === 'grade'
                    ? sorter.order
                    : 'none'
