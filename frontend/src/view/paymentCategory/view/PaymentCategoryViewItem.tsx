...
function PaymentCategoryViewItem(props) {
  ...
  const displayableRecord = (record, lastItem = false) => {
    return (
      ...
      >
        ...
        >
          <Icon fontSize="inherit">paymentCategory</Icon>
        </MDBox>
...
PaymentCategoryViewItem.defaultProps = {
  hiddenLabel: false,
};

PaymentCategoryViewItem.propTypes = {
  label: PropTypes.string,
  value: PropTypes.any,
  hiddenLabel: PropTypes.bool,
};

export default PaymentCategoryViewItem;
