...
const singleSchema = yup.object().shape({
  email: yupFormSchemas.email(i18n('student.fields.email')),
...
const multipleSchema = yup.object().shape({
  emails: yup
    .array()
    .label(i18n('student.fields.emails'))
    .of(
      yup
        .string()
        .transform((cv, ov) => {
        ...
        .email(i18n('student.validations.email'))
