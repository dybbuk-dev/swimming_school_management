  ...
  const displayableRecord = (record, lastItem = false) => {
    return (
      ...
      >
        ...
        >
          <Icon fontSize="inherit">grade</Icon>
        </MDBox>
...
GradeViewItem.defaultProps = {
  hiddenLabel: false,
};

GradeViewItem.propTypes = {
  label: PropTypes.string,
  value: PropTypes.any,
  hiddenLabel: PropTypes.bool,
};

export default GradeViewItem;
