  ...
  const displayableRecord = (record, lastItem = false) => {
    return (
      ...
      >
        ...
        >
          <Icon fontSize="inherit">pool</Icon>
        </MDBox>
...
PoolViewItem.defaultProps = {
  hiddenLabel: false,
};

PoolViewItem.propTypes = {
  label: PropTypes.string,
  value: PropTypes.any,
  hiddenLabel: PropTypes.bool,
};

export default PoolViewItem;
