...
import EditDocumentLayout from 'src/view/document/form/EditDocumentLayout';
...
import NewDocumentLayout from 'src/view/document/form/NewDocumentLayout';
    ...
    <FormWrapper>
      <FormProvider {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
          {!isEditing &&
            (modal ? (
              <NewDocumentLayout title={title} modal />
            ) : (
              <Grid
                container
                spacing={1.6}
